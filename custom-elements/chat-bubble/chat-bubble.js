class CustomChatBubble extends HTMLElement {
    ...
    render() {
        this.shadowRoot.innerHTML = `
            <link rel="stylesheet" href="./custom-elements/chat-bubble/chat-bubble.css">
            <button class="chat-bubble" id="chat-btn" aria-label="Open chat">
...
window.customElements.define('custom-chat-bubble', CustomChatBubble);
